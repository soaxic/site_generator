...
>Quote!"""
        pn = markdown_to_html_code(markdown)
        testcase = "ParentNode(div, [ParentNode(blockquote, [ParentNode(p, [LeafNode(None, This, None)], None), ParentNode(p, [LeafNode(None, Is, None)], None), ParentNode(p, [LeafNode(None, A, None)], None), ParentNode(p, [LeafNode(None, Quote!, None)], None)], None)], None)"
        self.assertEqual(testcase, str(pn))
